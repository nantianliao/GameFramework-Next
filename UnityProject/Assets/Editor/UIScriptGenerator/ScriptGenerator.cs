...
namespace UnityGameFramework.Editor.UI
{
    public class ScriptGenerator
    {
        ...
        public static string GetBtnFuncName(string varName)
        {
            ...
            {
                string varNameStr = varName.Replace("m_btn", string.Empty);
                return "OnClick_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Btn";

                // return "OnClick" + varName.Replace("m_btn", string.Empty) + "Btn";
            }
            else
            {
                string varNameStr = varName.Replace("_btn", string.Empty);
                return "OnClick_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Btn";
        ...
        public static string GetToggleFuncName(string varName)
        {
            ...
            if (codeStyle == UIFieldCodeStyle.MPrefix)
            {
                string varNameStr = varName.Replace("m_toggle", string.Empty);
                return "OnToggle_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Change";

                // return "OnToggle" + varName.Replace("m_toggle", string.Empty) + "Change";
            }
            else
            {
                string varNameStr = varName.Replace("_toggle", string.Empty);
                return "OnToggle_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Change";
        ...
        public static string GetSliderFuncName(string varName)
        {
            ...
            if (codeStyle == UIFieldCodeStyle.MPrefix)
            {
                string varNameStr = varName.Replace("m_slider", string.Empty);
                return "OnSlider_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Change";

                // return "OnSlider" + varName.Replace("m_slider", string.Empty) + "Change";
            }
            else
            {
                string varNameStr = varName.Replace("_slider", string.Empty);
                return "OnSlider_" + varNameStr.Substring(1, 1).ToUpper() + varNameStr.Substring(2) + "Change";
            ...
            ref StringBuilder strCallback, bool isUniTask)
        {
            ...
            bool isUIWidget = (rule != null && rule.isUIWidget);
